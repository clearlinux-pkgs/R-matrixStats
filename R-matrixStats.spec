...
Version  : 0.60.0
Release  : 42
URL      : https://cran.r-project.org/src/contrib/matrixStats_0.60.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/matrixStats_0.60.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627340022
