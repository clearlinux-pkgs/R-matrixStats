...
Version  : 0.60.1
Release  : 43
URL      : https://cran.r-project.org/src/contrib/matrixStats_0.60.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/matrixStats_0.60.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629740591
