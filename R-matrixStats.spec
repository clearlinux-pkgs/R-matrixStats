...
Version  : 0.59.0
Release  : 39
URL      : https://cran.r-project.org/src/contrib/matrixStats_0.59.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/matrixStats_0.59.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622565591
