...
Version  : 1.5.0
Release  : 68
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/matrixStats_1.5.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/matrixStats_1.5.0.tar.gz
...
%prep
%setup -q -n matrixStats
pushd ..
cp -a matrixStats buildavx2
popd
pushd ..
cp -a matrixStats buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736350029
...
/usr/lib64/R/library/matrixStats/NEWS.md
...
/usr/lib64/R/library/matrixStats/WORDLIST
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/matrixStats/libs/matrixStats.so
/V4/usr/lib64/R/library/matrixStats/libs/matrixStats.so
